...
| 输出 | 位置 |
|------|------|
| 论文笔记 | {vault}/1-Papers/By-Topic/{Topic}/{Year}-{Author}-{Title}.md |
| 语义记忆 | {vault}/memory/semantic/{Topic}.md |
| 程序记忆 | {vault}/memory/procedural/{Topic}.md |
| 情景记忆 | {vault}/memory/episodic/{Date}-{Paper}.md |
| MOC 更新 | {vault}/3-MOCs/MOC-{Topic}.md |
| 概念卡片 | {vault}/2-Knowledge/Concepts/ |
| 洞察卡片 | {vault}/2-Knowledge/Insights/ |
| 问题卡片 | {vault}/2-Knowledge/Questions/ |
| 方法卡片 | {vault}/2-Knowledge/Methods/ |
| 人物卡片 | {vault}/2-Knowledge/People/ |
| 反思输出 | {vault}/4-Outputs/Reflections/L1\|L2\|L3/ |
| 确认请求 | {vault}/0-Inbox/ |
